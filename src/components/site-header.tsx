    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
        <Link to="/" className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-(--gradient-hero) shadow-(--shadow-soft)">
            <Heart
        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
            <Link
              to="/staff/dashboard"
              className="hidden h-9 items-center gap-1.5 rounded-full bg-primary px-3.5 text-xs font-semibold text-primary-foreground shadow-(--shadow-soft) transition-opacity hover:opacity-95 sm:inline-flex"
            >
            ...
            {user ? (
              <>
                <Link
                  to="/staff/dashboard"
                  onClick={() => setOpen(false)}
                  className="mt-2 flex items-center justify-center gap-1.5 rounded-full bg-primary px-3 py-2 text-xs font-semibold text-primary-foreground"
                >
                  <LayoutDashboard className="h-3.5 w-3.5" />
                  Dashboard
                </Link>
                ...
                <button
                  ...
                  className="mt-1 flex items-center justify-center gap-1.5 rounded-full border border-border bg-muted px-3 py-2 text-xs font-semibold text-muted-foreground"
                >
