      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-4 md:px-6">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-foreground">{t("brand.fullName")}</span>
          </div>
          <p className="mt-3 max-w-md text-sm text-muted-foreground">{t("footer.about")}</p>
        </div>
        <div>
          <div className="text-sm font-semibold text-foreground">{t("footer.quickLinks")}</div>
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li><Link to="/procedures" className="hover:text-primary">{t("nav.procedures")}</Link></li>
            <li><Link to="/journey" className="hover:text-primary">{t("nav.journey")}</Link></li>
