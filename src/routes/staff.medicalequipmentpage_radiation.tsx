      ...
      <main style={{ flex: 1, padding: "28px 32px", overflowY: "auto" }}>
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 12, color: "#9ca3af", marginBottom: 8, display: "flex", alignItems: "center", gap: 6 }}>
            <span>งานการพยาบาลรังสีวิทยา</span><span>›</span><span>รังสีรักษาและมะเร็งวิทยา</span><span>›</span>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div>
              ...
              <p style={{ margin: "4px 0 0", fontSize: 13, color: "#6b7280" }}>ฝ่ายรังสีรักษาและมะเร็งวิทยา (Radiation Therapy) · โรงพยาบาลธรรมศาสตร์เฉลิมพระเกียรติ</p>
            </div>
