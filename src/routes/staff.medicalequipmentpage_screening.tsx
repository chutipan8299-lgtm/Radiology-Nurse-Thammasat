...
const sidebarDepts = [
  ...
  { label: "รังสีวินิจฉัย", sublabel: "Diagnostic Radiology", icon: "🩺", route: "/staff/medicalequipmentpage_screening", active: true },
];
  ...
  return (
    <button
      ...
      style={{
        ...
        textAlign: "left", textDecoration: hover ? "underline" : "none",
      }}
    >🔗 {label}</button>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        borderRadius: 6, width: "100%", textAlign: "center",
...
function StaffSection({
  staff, isAdmin, onEdit,
}: {
  staff: StaffMember; isAdmin: boolean; onEdit: (staff: StaffMember) => void;
}) {
  return (
    <div style={{
    ...
    <aside style={{
      ...
      <div style={{ padding: "0 16px 20px" }}>
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 800 }}>Radiology Nursing</div>
          <div style={{ fontSize: 11, opacity: 0.85 }}>Care · Guidance · Trust</div>
        </div>
      </div>
      ...
      {sidebarDepts.map((dept) => (
        <button
          ...
          style={{
            ...
            cursor: "pointer", display: "flex", gap: 10, marginBottom: 2,
          }}
        >
          ...
          <div>
            ...
            {dept.sublabel && (
              <div style={{ fontSize: 10, color: dept.active ? "#e879a0" : "#9ca3af" }}>
                {dept.sublabel}
              </div>
            )}
          </div>
...
function MedicalEquipmentPageScreening() {
  ...
  return (
    <div style={{
      ...
      <main style={{ flex: 1, padding: isMobile ? "16px 12px" : "28px 32px", minWidth: 0 }}>

        {/* Breadcrumb */}
        {!isMobile && (
          <div style={{ fontSize: 12, color: "#9ca3af", marginBottom: 8 }}>
            งานการพยาบาลรังสีวิทยา › รังสีวินิจฉัย ›{" "}
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ margin: "4px 0 0", fontSize: 13, color: "#6b7280" }}>
                ฝ่ายรังสีวินิจฉัย (Diagnostic Radiology)
              </p>
            </div>
