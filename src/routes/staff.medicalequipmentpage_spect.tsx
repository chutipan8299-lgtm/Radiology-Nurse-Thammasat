...
const sidebarDepts = [
  ...
  { label: "เวชศาสตร์นิวเคลียร์", sublabel: "SPECT / CT", icon: "☢️", route: "/staff/medicalequipmentpage_spect", active: true },
        ...
        {isAdmin && (
          <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
            <button
              ...
              onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = "#fce7f3"; }}
...
function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      minHeight: "100vh", boxShadow: "2px 0 12px rgba(232,121,160,0.07)",
    }}>
        ...
        <main style={{ flex: 1, padding: isMobile ? "16px 12px" : "28px 32px", overflowY: "auto", minWidth: 0 }}>
          ...
          {!isMobile && (
            <div style={{ fontSize: 12, color: "#9ca3af", marginBottom: 8, display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <span>เวชศาสตร์นิวเคลียร์</span><span>›</span>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                <h1 style={{ margin: 0, fontSize: isMobile ? 18 : 22, fontWeight: 800, color: "#1e1b4b", letterSpacing: -0.3 }}>
