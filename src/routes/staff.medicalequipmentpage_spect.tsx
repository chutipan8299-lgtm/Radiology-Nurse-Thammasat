...
export const Route = createFileRoute('/staff/medicalequipmentpage_spect')({
  component: MedicalEquipmentPageSpect,
});
...
const staffData: StaffMember[] = [
  {
    name: "น.ส.ชญาภา กฤติพงศ์ณวกุล",
    equipment: [{ id: "TUH-03980", label: "TUH-03980" }],
  },
  {
    name: "นายกิติศักดิ์ คู่กระสังข์",
    equipment: [{ id: "TUH-03437", label: "TUH-03437" }],
  },
  {
    name: "นายอัศรา สิงหล้า",
    equipment: [{ id: "TUH-01922", label: "TUH-01922" }],
  },
  {
    name: "น.ส.ดารารัศมี มีมูซอ",
    equipment: [{ id: "TUH-01932", label: "TUH-01932" }],
  },
  {
    name: "น.ส.นฤมล ราชสีหา",
    equipment: [{ id: "TUH-03664", label: "TUH-03664" }],
  },
  {
    name: "น.ส.โยษิตา ค้าผล",
    equipment: [{ id: "TUH-04166", label: "TUH-04166" }],
  },
  {
    name: "น.ส.ญาราภรณ์ ปรังฤทธิ์",
    equipment: [{ id: "TUH-03600", label: "TUH-03600" }],
  },
  {
  ...
  {
    name: "น.ส.ศศิธร พุทธทอง",
    equipment: [{ id: "TUH-03921", label: "TUH-03921" }],
  },
  {
    name: "นายพรเทพ เทาดี",
    equipment: [{ id: "TUH-01912", label: "TUH-01912" }],
  },
  {
...
const sidebarDepts = [
  ...
  },
  {
    ...
    sublabel: "Radiation Therapy",
    icon: "🎯",
    route: "/staff/medicalequipmentpage_radiation",
  },
  {
    label: "รังสีวินิจฉัย",
    sublabel: "Diagnostic Radiology",
    icon: "🩺",
    route: "/staff/medicalequipmentpage_sceening",
  },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? "0 4px 20px rgba(232,121,160,0.18)"
          ...
          <div>
            ...
            {dept.sublabel && (
              <div
                style={{
                  fontSize: 10,
                  color: dept.active ? "#e879a0" : "#9ca3af",
                  fontWeight: 500,
                }}
              >
                {dept.sublabel}
...
function SearchBar({
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
      ...
      >
        ทั้งหมด {staffData.length} คน ·{" "}
        {staffData.reduce((s, d) => s + d.equipment.length, 0)} รายการ
      </div>
    </div>
  );
}
...
// ---- Main Component ----
function MedicalEquipmentPageSpect() {
      ...
      <div style={{ display: "flex", flex: 1 }}>
        ...
        <main style={{ flex: 1, padding: "28px 32px", overflowY: "auto" }}>
          <div style={{ marginBottom: 24 }}>
            ...
            >
              <span>งานการพยาบาลรังสีวิทยา</span>
              <span>›</span>
              <span>เวชศาสตร์นิวเคลียร์</span>
              <span>›</span>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div>
                ...
                >
                  ฝ่ายเวชศาสตร์นิวเคลียร์ (SPECT / CT) · โรงพยาบาลธรรมศาสตร์เฉลิมพระเกียรติ
                </p>
              </div>
          ...
          <div
            style={{
              height: 1,
              background: "linear-gradient(90deg, #fbb6ce, transparent)",
              marginBottom: 24,
            }}
          />
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((staff) => (
              <StaffSection key={staff.name} staff={staff} />
            ))
          )}
        </main>
      </div>
